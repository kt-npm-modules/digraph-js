...
Defines GitHub Actions workflow requirements for CI, release, auto-merge, auto-release, contribution branch automation, and code scanning, mirroring the `kt-npm-modules/npm-typescript-template` template while accommodating package-specific adaptations.
